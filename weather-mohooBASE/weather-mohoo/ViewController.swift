...
//                    }
//                    
//                    var zhishubutton = UIButton()
//                    zhishubutton.frame = CGRectMake(CGFloat(j)*135 + 30,CGFloat(i - j + 1) * 25 + 300,130,40)
//                    zhishubutton.backgroundColor = UIColor(red: CGFloat(93)/255.0, green: CGFloat(138)/255.0, blue: CGFloat(150)/255.0, alpha: 0.3)
//                    
//                    var tishides = index[i].objectForKey("des") as NSString
//                    
//                    var zhishuinformation = index[i].objectForKey("tipt") as NSString
//                    var zhishudegree = index[i].objectForKey("zs") as NSString
//                    zhishubutton.setTitle("\(zhishuinformation)\n\(zhishudegree)", forState:.Normal)
//                    zhishubutton.titleLabel.numberOfLines = 2
//                    zhishubutton.titleLabel.textAlignment =  NSTextAlignment.Center
//                    zhishubutton.titleLabel.font = UIFont.systemFontOfSize(12)
//                    zhishubutton.addTarget(self, action: "disdetail",forControlEvents:.TouchUpInside)
//                    self.view.addSubview(zhishubutton)
//                    
//                }
